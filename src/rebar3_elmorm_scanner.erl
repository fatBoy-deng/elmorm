-file("d:/software/erl10.2/lib/parsetools-2.1.8/include/leexinc.hrl", 0).
...
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 24).
...
is_keyword(_) -> false.
-file("d:/software/erl10.2/lib/parsetools-2.1.8/include/leexinc.hrl", 14).
...
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.erl", 363).
yystate() -> 22.
...
yystate(24, [10|Ics], Line, Tlen, _, _) ->
    yystate(24, Ics, Line+1, Tlen+1, 5, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(24, Ics, Line, Tlen+1, 5, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 32 ->
    yystate(24, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 49, C =< 57 ->
...
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 9).
yyaction_0(TokenChars, TokenLen, TokenLine) ->
     { token, { name, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_1/2}).
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 10).
yyaction_1(TokenChars, TokenLine) ->
     { token, keyword_or_var (TokenChars, TokenLine) } .

-compile({inline,yyaction_2/3}).
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 11).
yyaction_2(TokenChars, TokenLen, TokenLine) ->
     { token, { string, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_3/3}).
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 12).
yyaction_3(TokenChars, TokenLen, TokenLine) ->
     { token, { string, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_4/2}).
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 13).
yyaction_4(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_5/0}).
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 14).
yyaction_5() ->
     skip_token .

-compile({inline,yyaction_6/2}).
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 15).
yyaction_6(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_7/2}).
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 16).
yyaction_7(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_8/2}).
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 17).
yyaction_8(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, hex_to_int (TokenChars) } } .

-compile({inline,yyaction_9/1}).
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 18).
yyaction_9(TokenLine) ->
     { token, { qualifier, TokenLine, "@@" } } .

-compile({inline,yyaction_10/0}).
-file("e:/tianming_branch/20191108/elmorm/src/elmorm_scanner.xrl", 19).
yyaction_10() ->
     skip_token .

-file("d:/software/erl10.2/lib/parsetools-2.1.8/include/leexinc.hrl", 313).
